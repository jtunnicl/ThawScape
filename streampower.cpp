...
void StreamPower::SetTopo(std::vector<std::vector<real_type>> t)
{
	topo = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	topo2 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	topoold = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	slope = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	aspect = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));

	// Radiation Model
	solar_raster = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	shade_raster = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	I_D = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	I_R = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	I_P = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	N_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	E_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	S_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	W_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	NE_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	SE_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	SW_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	NW_Ip = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));

	// Landscape Elements
	veg = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	veg_old = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	Sed_Track = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	ExposureAge = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	ExposureAge_old = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));

	// Indexing
    topo_indexx = Indexx<real_type>(lattice_size_x, lattice_size_y);
    sed_indexx = Indexx<real_type>(lattice_size_x, lattice_size_y);
    
    // debugging
	debug_raster = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
...
void StreamPower::SetFA(std::vector<std::vector<real_type>> f)
{

	flow = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	flow1 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow2 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow3 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow4 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow5 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow6 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow7 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
    flow8 = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
	FA_Bounds = std::vector<std::vector<real_type>>(lattice_size_x, std::vector<real_type>(lattice_size_y));
...
void StreamPower::PrintState(const char* fname, std::vector<std::vector<real_type> > &state)
{
...
std::vector<std::vector<real_type>> StreamPower::GetTopo()
{
	return topo;
}
